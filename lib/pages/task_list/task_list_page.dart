...
class _TaskListPageState extends State<TaskListPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (taskGroupProvider.selectedTaskGroup != null) {
    ...
    return Scaffold(
      appBar: AppBar(
        actions: [
          IconButton(
            onPressed: () {
              // Aqui você pode implementar a navegação para a página de edição, caso necessário.
            },
          ...
          children: [
            Padding(
              ...
              child: TasksSummaryWidget(
                taskGroup: taskGroupProvider.selectedTaskGroup!,
